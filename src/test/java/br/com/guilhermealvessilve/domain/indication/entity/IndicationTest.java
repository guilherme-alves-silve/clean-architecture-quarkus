...
class IndicationTest {
    ...
    void shouldThrowExceptionWhenCreatingInvalidIndication() {
        ...
        Assertions.assertAll(
                ...
                () -> assertThrows(NullPointerException.class, () -> new Indication(null, createStudent(), LocalDate.now()), "indication.indicator null"),
                () -> assertThrows(NullPointerException.class, () -> new Indication(createStudent(), null, LocalDate.now()), "indication.indicated null"),
